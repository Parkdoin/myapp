 ...
 * Generated at: 2021-09-23 01:46:36 UTC
...
public final class flist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("ch07.FileloadBean");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      ch07.FileloadMgr mgr = null;
      mgr = (ch07.FileloadMgr) _jspx_page_context.getAttribute("mgr", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (mgr == null){
        mgr = new ch07.FileloadMgr();
      ...
      out.write("		if(f.allCh.checked/*체크가 된 상태*/){\r\n");
      ...
      out.write("		f=document.frm;\r\n");
      out.write("		for(i=1;i<f.fch.length;i++){\r\n");
      out.write("			if(f.fch[i].checked/*fch 체크인 경우*/){\r\n");
      out.write("				f.btn.disabled=false;//버튼의 활성화\r\n");
      out.write("				f.btn.style.color =\"blue\";\r\n");
      out.write("				return;//function 전체를 빠져 나감.\r\n");
      out.write("			}//---if\r\n");
      out.write("		}//---for\r\n");
      ...
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	function downFn(file) {\r\n");
      out.write("		df=document.downFrm;\r\n");
      out.write("		df.upFile.value=file;\r\n");
      out.write("		df.submit();\r\n");
      out.write("	}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      ...
      out.write("<!-- 업로된 파일이 한개이면 fch가 배열이 안되기 때문에 fch value값을 0을 히든타입으로 추가 -->\r\n");
      ...
      out.write("			");
      out.write("\r\n");
      out.write("			<a href=\"javascript:downFn('");
      out.print(upFile);
      out.write("')\">");
      out.print(upFile);
      out.write("</a>\r\n");
