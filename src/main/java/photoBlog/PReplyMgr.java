...
public class PReplyMgr {
	...
	//PReply Insert : ´ñ±Û ÀÔ·Â
	//insert tblPReply(num,id,rdate,comment)values(?,?,now(),?)
	...
	//PReply Delete : ´ñ±Û »èÁ¦
	//delete from tblPReply where rnum=?
	...
	//PReply All Delete : PhotoBlog »èÁ¦½Ã °ü·ÃµÈ ´ñ±Û ¸ðµÎ »èÁ¦
	...
	//PReply List :´ñ±Û ¸®½ºÆ®
	//select * from tblPReply where num=? order by rnum desc
